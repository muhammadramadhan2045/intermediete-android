...
class MyEditText : AppCompatEditText, View.OnTouchListener {
    ...
    private fun init() {
        ...
        //menambahkan aksi ketika clear button ditekan
        setOnTouchListener(this)

        //menambahkan aksi ketika text berubah
    ...
    private fun showClearButton() {
        setButtonDrawables(endTheText = clearButtonImage)
    }
